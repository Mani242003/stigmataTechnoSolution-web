...
const Policy = () => {
  ...
  <div className="bg-primary text-white p-[3rem]">
  <span className="text-white text-5xl font-extrabold">Cookie Policy</span>
</div>
  <div className="policy_Content p-8">
    <span className="textTitle text-2xl font-bold">What are cookies?</span>
    <br />
    <br />
    <span className="textDes text-base leading-6 tracking-wide">
      <span className="font-bold text-lg">A cookie</span> is a small file, typically consisting of
      ...
      <span className="font-bold text-lg">Cookies enable Stigmata Techno Solution</span> to recognize
      ...
      <br />
      <br />
      <span className="font-bold text-lg">Please note</span> that cookies by themselves do not reveal
      ...
      <a href="mailto:jerome@stigmatatech.com">jerome@stigmatatech.com</a> Any changes in this policy
